...
(function dartProgram() {
  ...
  F = {
    main: function() {
      ...
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Siistia?", "vaihtoehdot", vaihtoehdot], t1, t2));
    ...
    asetaVastausvaihtoehdot: function(vaihtoehdot) {
      var t1, i, t2;
      ...
      while (true) {
        ...
        if (!(i < t2))
          break;
        F.lisaaVastausvaihtoehto(t1.$index(vaihtoehdot, i));
        ++i;
      }
    },
    lisaaVastausvaihtoehto: function(vaihtoehto) {
      var t2, t3,
        t1 = document,
        elementti = t1.createElement("div");
      elementti.className = "vaihtoehto";
      C.DivElement_methods.set$text(elementti, H._asStringQ(J.$index$asx(vaihtoehto, "teksti")));
  ...
  F.main_closure.prototype = {
    call$1: function(e) {
      ...
      J.set$text$x(document.querySelector("#kysymys"), H._asStringQ(t3));
      F.asetaVastausvaihtoehdot(t2.$index(t1, "vaihtoehdot"));
    },
    $signature: 4
  };
  F.lisaaVastausvaihtoehto_closure.prototype = {
    call$1: function(e) {
      ...
      if (H.boolConversionCheck(H._asBoolS(J.$index$asx(this.vaihtoehto, "oikein"))))
        ...
        C.DivElement_methods.set$text(t1, "vaarin!");
    },
    $signature: 4
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Error, [P.TypeError, H.JsNoSuchMethodError, H.UnknownJsTypeError, H.RuntimeError, P.AssertionError, H._Error, P.NullThrownError, P.ArgumentError, P.UnsupportedError, P.UnimplementedError, P.ConcurrentModificationError, P.CyclicInitializationError]);
